...
if os.environ.get("IS_PRODUCTION_SERVER")=="True":
	...
	EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD") # Si se quiere cambiar el user y password, revisar 'https://dev.to/abderrahmanemustapha/how-to-send-email-with-django-and-gmail-in-production-the-right-way-24ab'
